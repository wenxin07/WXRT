...
public class HotelSearchController {
    ...
    public String getHotels(@RequestParam(value = "city", required = false) String city,
                            Pageable pageable, Model model) {
    	Page<Hotel> results = null;
    	if(city==null) {
    		results = hotelRepository.findAll(pageable);
    	} else {
    		results = hotelRepository.findByCity(city, pageable);    		
    	}
